...
user1_OS= user_string1[13:27].lower()
...
### Exercise 3.4: Use collections, lists, sets, and dictionaries to create a set of infrequently 
# occuring terms in the cleaned profiles and remove them from the profiles. Create 
